...
export class MessageService {
  ...
  constructor(private authService : AuthService) {
  	...
  	this.gameMessages = [
			...
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'If you are clever enough, I will give you your information back and you won\'t be hearing from me anymore', continous: true, incoming: true, delay: 3000 },
			...
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'You are getting hang on this. Next one ain\'t going to be this easy...' , continous: true, incoming: true, points: 100, delay: 1000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'I have hidden clues/answers around you.', continous: true, incoming: true, delay: 2000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), image: this.user.photoURL, continous: true, incoming: true, delay: 3000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'What is the word in the note?', continous: false, responseRequired: true, answer: 'Bloodthirst', incoming: true, delay: 4000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Ah.. You found it!', continous: true, incoming: true, points: 100, delay: 1000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Next one.. Before people used pumpkins, what were Jack O\' Lanterns made out of?', continous: true, incoming: true, delay: 5000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Answer with a number. 1. Potatoes, 2. Turnips, 3. Bananas, 4. Onions', continous: false, responseRequired: true, answer: '2', points: 100, incoming: true, delay: 4000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Turnips!', continous: true, incoming: true, points: 100, delay: 1000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Oh shit.. You need to move again. Next hidden clue....', continous: true, incoming: true, delay: 2000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), image: this.user.photoURL, continous: true, incoming: true, delay: 3000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'What is the answer?', continous: false, responseRequired: true, answer: 'Skull', incoming: true, delay: 4000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'You are so clever! I\'m not sure if you can handle next one..', continous: true, incoming: true, points: 100, delay: 1000 },
			...
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Well that\'s just fun number, isn\'t it?', continous: true, incoming: true, points: 100, delay: 1000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Okey.. Last one...', continous: true, incoming: true, delay: 2000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), image: this.user.photoURL, continous: true, incoming: true, delay: 3000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Aaaaaaaaaaaand the answer is?', continous: false, responseRequired: true, answer: 'Henri on paras! <3', incoming: true, delay: 4000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Gongratulations. Your personal information is no longer in my posession... Bye...', continous: true, incoming: true, points: 100, delay: 3000 },
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Bye', continous: true, incoming: true, delay: 10000 },
