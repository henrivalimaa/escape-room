...
const GAME_MESSAGES: any = [
	...
	{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'The right answer was SIX WOLVES.', continous: true, points: 100, incoming: true, delay: 4000 },
	...
	{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'Gongratulations. You finished before the explosion. Your time was TIME.', continous: true, incoming: true, points: 100, delay: 3000 },
