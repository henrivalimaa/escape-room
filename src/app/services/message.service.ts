...
export class MessageService {
  ...
  constructor(private authService : AuthService) {
  	...
  	this.gameMessages = [
			...
			{ time: new Date().getHours() + '.' + new Date().getMinutes(), text: 'What is my phone number? Can you find it?', continous: false, responseRequired: true, answer: '0406660666', incoming: true, delay: 4000 },
